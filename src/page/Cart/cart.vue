        ...
        <div v-else style="padding:50px">
          ...
          <div style="text-align: center">
            <router-link to="/goods">
              <y-button text="现在选购" style="width: 150px;height: 40px;line-height: 38px;color: #black;font-size: 14px;"></y-button>
            </router-link>
          </div>
...
.cart-e {
  margin: 0 auto;
  background: url("/static/images/shopingcar.png") no-repeat;
  width: 500px;
  height: 350px;
  color: #8d8d8d;
}
